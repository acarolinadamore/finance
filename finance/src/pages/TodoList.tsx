...
interface SortableTodoListCardProps {
  list: any
  ...
  onReorderItems: (listId: number, newOrder: any[]) => void
}

const SortableTodoListCard = (props: SortableTodoListCardProps) => {
  const {
    attributes,
    listeners,
    setNodeRef,
  ...
  return (
    <div ref={setNodeRef} style={style}>
      <TodoListCard {...props} dragHandleProps={{ ...attributes, ...listeners }} />
    </div>
  )
}
...
const TodoList = () => {
  ...
  const handleDownloadLists = async () => {
    ...
    try {
      ...
      pdf.save(`lista-de-tarefas-${date}.pdf`)

      setIsDownloadDialogOpen(false)
      setSelectedLists([])
    } catch (error) {
      console.error("Erro ao baixar lista:", error)
      alert("Erro ao baixar lista de tarefas")
    }
  }
  ...
  return (
    <div className="min-h-screen bg-background">
            ...
            <div className="flex items-center gap-2">
              ...
              <DialogContent>
                <DialogHeader>
                  ...
                  <DialogDescription>
                    Dê um nome para sua nova lista de tarefas
                  </DialogDescription>
                </DialogHeader>
                <div className="space-y-4 py-4">
                  <div className="space-y-2">
                    ...
                    <Input
                      id="listName"
                      placeholder="Ex: Tarefas do dia, Projetos..."
                      value={newListName}
      ...
      <Dialog open={isDownloadDialogOpen} onOpenChange={setIsDownloadDialogOpen}>
        <DialogContent>
          <DialogHeader>
            <DialogTitle>Baixar Lista de Tarefas</DialogTitle>
            <DialogDescription>
