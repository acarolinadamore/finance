...
interface EditDreamDialogProps {
  ...
  lifeAreas: LifeArea[]
  onUpdateDream: (id: number, updates: {
    title: string
    description?: string
    image?: string
    deadline?: string
...
export const EditDreamDialog = ({
  ...
  useEffect(() => {
    if (dream && open) {
      ...
      setLifeAreaId(dream.life_area_id ? dream.life_area_id.toString() : "")
      setPrazoTipo(dream.prazo_tipo || "")
      setDescription(dream.description || "")
      setImage(dream.image || "")
      setImagePreview(dream.image || "")
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      alert("Erro ao atualizar sonho. Tente novamente.")
    } finally {
      setSaving(false)
    }
  }
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-xl max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          ...
          <DialogDescription>
            Atualize as informações do seu sonho
          </DialogDescription>
        </DialogHeader>
